...
const JOURNEY_CATEGORIES: JourneyCategory[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { path: "/projeto-autonomo/protocolos-apagao", title: "Protocolos Apagão" },
      { path: "/projeto-autonomo/purificacao-agua", title: "Purificação Água" },
      { path: "/projeto-autonomo/abrigo-emergencia", title: "Abrigo Emergência" },
      { path: "/projeto-autonomo/comunicacao-offline", title: "Comunicação Offline" },
      { path: "/projeto-autonomo/navegacao-primaria", title: "Navegação Primária" },
      { path: "/projeto-autonomo/autonomia-biologica", title: "Autonomia Biológica" },
      { path: "/projeto-autonomo/horta-urbana", title: "Horta Urbana" },
      { path: "/projeto-autonomo/primeiros-socorros", title: "Primeiros Socorros" },
      { path: "/projeto-autonomo/avaliacao-sinais", title: "Avaliação Sinais" },
      { path: "/projeto-autonomo/saude-preventiva", title: "Saúde Preventiva" },
      { path: "/projeto-autonomo/fitoterapia-aplicada", title: "Fitoterapia" },
      { path: "/projeto-autonomo/controle-vetores", title: "Controle Vetores" },
      { path: "/projeto-autonomo/conservacao-armazenamento", title: "Conservação" },
      { path: "/projeto-autonomo/producao-pequenos-espacos", title: "Pequenos Espaços" },
      { path: "/projeto-autonomo/proteina-sustentavel", title: "Proteína Sustentável" },
      { path: "/projeto-autonomo/solo-fertilidade", title: "Solo & Fertilidade" },
      { path: "/projeto-autonomo/sabedoria-ancestral", title: "Sabedoria Ancestral" },
      { path: "/projeto-autonomo/conhecimento-perdido", title: "Conhecimento Perdido" },
    ],
  },
];
