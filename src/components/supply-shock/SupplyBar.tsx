...
export const SupplyBar: React.FC<SupplyBarProps> = ({ circulatingSupply, percentageMined }) => {
  ...
  return (
    <div className="w-full max-w-4xl px-4 mt-8 mb-12 relative z-10">
      <div className="flex justify-between items-end mb-4">
        <div>
          <div className="flex items-center gap-2 text-[#F7931A]">
            ...
            <span className="text-sm font-bold tracking-wider uppercase">Minerado</span>
          </div>
        ...
        <div className="text-right">
          <span className="text-sm font-bold tracking-wider uppercase text-gray-500">Total Absoluto</span>
      ...
      <div className="relative h-8 md:h-12 bg-gray-900 border border-gray-800 rounded-sm overflow-hidden shadow-[0_0_15px_rgba(247,147,26,0.2)]">
        ...
        <div
          className="h-full bg-[#F7931A] relative"
      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center gap-3 bg-[#EF4444]/10 border border-[#EF4444] px-6 py-4 rounded-sm animate-pulse">
          <AlertTriangle className="text-[#EF4444] w-6 h-6" />
          <p className="text-[#EF4444] font-black text-sm md:text-lg tracking-widest uppercase">
