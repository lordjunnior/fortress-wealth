...
export default function SmokeBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none z-[2] overflow-hidden">
      ...
      <motion.div
        className="absolute -inset-[20%] opacity-[0.10]"
        animate={{ x: ['-5%', '5%', '-5%'], y: ['0%', '-3%', '0%'] }}
        transition={{ duration: 45, repeat: Infinity, ease: 'easeInOut' }}
        style={{
          background:
            'radial-gradient(ellipse 60% 40% at 30% 80%, rgba(120,120,130,0.45), transparent 60%), radial-gradient(ellipse 50% 35% at 70% 75%, rgba(100,90,90,0.35), transparent 60%)',
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(140,130,125,0.4), transparent 65%), radial-gradient(ellipse 40% 30% at 20% 30%, rgba(110,100,100,0.3), transparent 60%)',
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 20%, rgba(160,150,145,0.35), transparent 70%)',
