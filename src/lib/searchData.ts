...
export const SEARCH_ENTRIES: SearchEntry[] = [
  ...
  { title: "Conservação & Armazenamento", description: "Técnicas de conservação de alimentos", path: "/soberania-organica/conservacao-armazenamento", tags: ["conservação", "armazenamento", "alimento", "estoque"], category: "Soberania Orgânica" },
