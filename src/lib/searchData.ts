...
export const SEARCH_ENTRIES: SearchEntry[] = [
  ...
  // Projeto Autônomo
  { title: "Projeto Autônomo", description: "Autonomia prática: alimento, saúde e sobrevivência", path: "/projeto-autonomo", tags: ["autônomo", "autonomia", "sobrevivência", "prática"], category: "Projeto Autônomo" },
  { title: "Kit 72h", description: "Kit de emergência para 72 horas", path: "/projeto-autonomo/kit-72h", tags: ["kit", "72h", "emergência", "sobrevivência"], category: "Projeto Autônomo" },
  { title: "Purificação de Água", description: "Técnicas para purificar água", path: "/projeto-autonomo/purificacao-agua", tags: ["água", "purificação", "filtro", "sobrevivência"], category: "Projeto Autônomo" },
  { title: "Protocolos de Apagão", description: "O que fazer em um blackout", path: "/projeto-autonomo/protocolos-apagao", tags: ["apagão", "blackout", "protocolo", "energia"], category: "Projeto Autônomo" },
  { title: "Abrigo de Emergência", description: "Construção de abrigos temporários", path: "/projeto-autonomo/abrigo-emergencia", tags: ["abrigo", "emergência", "construção", "temporário"], category: "Projeto Autônomo" },
  { title: "Comunicação Offline", description: "Rádio e comunicação sem internet", path: "/projeto-autonomo/comunicacao-offline", tags: ["comunicação", "offline", "rádio", "mesh"], category: "Projeto Autônomo" },
  { title: "Navegação Primária", description: "Orientação sem GPS", path: "/projeto-autonomo/navegacao-primaria", tags: ["navegação", "bússola", "estrelas", "orientação"], category: "Projeto Autônomo" },
  { title: "Horta Urbana", description: "Produção de alimentos em espaços urbanos", path: "/projeto-autonomo/horta-urbana", tags: ["horta", "urbana", "alimento", "cultivo"], category: "Projeto Autônomo" },
  { title: "Autonomia Biológica", description: "Plantas medicinais e ervas", path: "/projeto-autonomo/autonomia-biologica", tags: ["biológica", "plantas", "ervas", "medicinal"], category: "Projeto Autônomo" },
  { title: "Primeiros Socorros", description: "Técnicas básicas de socorro", path: "/projeto-autonomo/primeiros-socorros", tags: ["primeiros socorros", "saúde", "emergência", "medicina"], category: "Projeto Autônomo" },
  { title: "Saúde Preventiva", description: "Prevenção e auto-cuidado", path: "/projeto-autonomo/saude-preventiva", tags: ["saúde", "preventiva", "prevenção", "cuidado"], category: "Projeto Autônomo" },
  { title: "Fitoterapia Aplicada", description: "Uso prático de plantas medicinais", path: "/projeto-autonomo/fitoterapia-aplicada", tags: ["fitoterapia", "plantas", "medicinal", "natural"], category: "Projeto Autônomo" },
  { title: "Conservação & Armazenamento", description: "Técnicas de conservação de alimentos", path: "/projeto-autonomo/conservacao-armazenamento", tags: ["conservação", "armazenamento", "alimento", "estoque"], category: "Projeto Autônomo" },
  { title: "Produção em Pequenos Espaços", description: "Cultivo em apartamentos e varandas", path: "/projeto-autonomo/producao-pequenos-espacos", tags: ["pequenos espaços", "apartamento", "varanda", "cultivo"], category: "Projeto Autônomo" },
  { title: "Proteína Sustentável", description: "Fontes alternativas de proteína", path: "/projeto-autonomo/proteina-sustentavel", tags: ["proteína", "sustentável", "alimento", "alternativa"], category: "Projeto Autônomo" },
  { title: "Solo e Fertilidade", description: "Preparação e manutenção do solo", path: "/projeto-autonomo/solo-fertilidade", tags: ["solo", "fertilidade", "compostagem", "terra"], category: "Projeto Autônomo" },
  { title: "Sabedoria Ancestral", description: "Conhecimentos tradicionais de sobrevivência", path: "/projeto-autonomo/sabedoria-ancestral", tags: ["ancestral", "tradicional", "sabedoria", "conhecimento"], category: "Projeto Autônomo" },
  { title: "Conhecimento Perdido", description: "Habilidades esquecidas pela modernidade", path: "/projeto-autonomo/conhecimento-perdido", tags: ["conhecimento", "perdido", "habilidade", "esquecido"], category: "Projeto Autônomo" },
  { title: "Controle de Vetores", description: "Controle de pragas e vetores de doenças", path: "/projeto-autonomo/controle-vetores", tags: ["vetores", "pragas", "controle", "doenças"], category: "Projeto Autônomo" },
