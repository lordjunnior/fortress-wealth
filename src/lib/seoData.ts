...
export const SEO_DATA: Record<string, SeoPageData> = {
  ...
  '/teoria-das-bandeiras': {
    ...
    relatedPages: ['/taxa-de-fuga', '/soberania-financeira', '/economia-paralela'],
  },
  '/taxa-de-fuga': {
  ...
  '/pix-cripto': {
    ...
    articleSection: 'Soberania Financeira',
    clusterParent: '/soberania-financeira',
    relatedPages: ['/comprar-bitcoin-anonimo', '/soberania-financeira/exchanges-sem-kyc', '/lightning'],
  },
  '/comprar-bitcoin-anonimo': {
    ...
    canonical: `${BASE}/comprar-bitcoin-anonimo`,
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Soberania Financeira', url: '/soberania-financeira' }, { name: 'Comprar Bitcoin Anônimo', url: '/comprar-bitcoin-anonimo' }],
    schemaType: 'HowTo',
    articleSection: 'Soberania Financeira',
    clusterParent: '/soberania-financeira',
    relatedPages: ['/soberania-financeira/exchanges-sem-kyc', '/pix-cripto', '/blindagem-golpes'],
  },
  '/economia-paralela': {
  ...
  '/alertas/governo-tomar-bitcoins': {
    ...
    canonical: `${BASE}/alertas/governo-tomar-bitcoins`,
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Alertas', url: '/alertas' }, { name: 'Confisco de Bitcoin', url: '/alertas/governo-tomar-bitcoins' }],
    schemaType: 'Article',
    articleSection: 'Alertas',
    clusterParent: '/alertas',
  ...
  '/soberania-organica/purificacao-agua': {
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Soberania Orgânica', url: '/soberania-organica' }, { name: 'Purificação de Água', url: '/soberania-organica/purificacao-agua' }],
    schemaType: 'HowTo',
    articleSection: 'Soberania Orgânica',
    clusterParent: '/soberania-organica',
  ...
  '/soberania-organica/autonomia-biologica': {
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Soberania Orgânica', url: '/soberania-organica' }, { name: 'Autonomia Biológica', url: '/soberania-organica/autonomia-biologica' }],
  ...
  '/indice-do-despertar': {
    ...
    canonical: `${BASE}/indice-do-despertar`,
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Educação', url: '/educacao' }, { name: 'Índice do Despertar', url: '/indice-do-despertar' }],
    schemaType: 'WebPage',
    articleSection: 'Educação',
  ...
  '/indice-de-soberania-financeira': {
    ...
    articleSection: 'Soberania Financeira',
    clusterParent: '/soberania-financeira',
    relatedPages: ['/soberania-financeira', '/soberania-financeira/exchanges-sem-kyc'],
  },
  '/arsenal': {
    ...
    breadcrumbs: [{ name: 'Início', url: '/' }, { name: 'Arsenal', url: '/arsenal' }],
    schemaType: 'CollectionPage',
    articleSection: 'Educação',
