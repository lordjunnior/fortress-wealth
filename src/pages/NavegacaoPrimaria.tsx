    ...
    <div className="min-h-screen selection:bg-teal-300/30" style={{ background: '#050808' }}>
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 pt-12 pb-32">
          ...
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl p-5 md:p-6 mb-4">
            <h3 className="text-sm font-bold text-rose-600 uppercase tracking-wider mb-3">📌 Fundamento Biológico e Operacional</h3>
            <p className="text-stone-600 text-sm leading-relaxed mb-3">O cérebro humano depende de referências espaciais claras. Quando você não sabe onde está:</p>
            <div className="grid grid-cols-3 gap-2 mb-4">
              {['O cortisol sobe', 'O raciocínio piora', 'Decisões se tornam impulsivas'].map(item => (
                <div key={item} className="bg-red-50/60 rounded-lg p-2.5 text-center">
            ...
            <div className="bg-rose-50 border border-rose-200/60 rounded-xl p-3">
              <p className="text-stone-800 text-sm font-bold flex items-center gap-2">
                <Brain size={14} className="text-rose-500" /> Direção clara mantém estabilidade cognitiva.
              </p>
            </div>
          </div>
        ...
        <Section num={1} title="Orientação Solar">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">
            O sol nasce aproximadamente no <strong className="text-stone-800">Leste</strong> e se põe no <strong className="text-stone-800">Oeste</strong>.
          </p>
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="bg-amber-50 border border-amber-200/60 rounded-xl p-4 text-center">
              ...
              <span className="text-sm font-bold text-stone-800 block">Manhã</span>
              <span className="text-xs text-stone-600">Sol está a Leste</span>
            </div>
            <div className="bg-orange-50 border border-orange-200/60 rounded-xl p-4 text-center">
              <Sun size={20} className="text-orange-500 mx-auto mb-2" />
              <span className="text-sm font-bold text-stone-800 block">Tarde</span>
              <span className="text-xs text-stone-600">Sol está a Oeste</span>
            </div>
          </div>
          <div className="bg-white/80 border border-stone-200/60 rounded-xl p-4 mb-4">
            <p className="text-stone-600 text-sm">Ao meio-dia (aproximado), no Brasil: <strong className="text-stone-800">o sol tende a estar mais ao Norte</strong>.</p>
          </div>
          ...
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl overflow-hidden">
            ...
            <div className="p-5 md:p-6">
              <h3 className="text-lg font-bold text-stone-800 mb-3">Técnica da Sombra (Método do Bastão)</h3>
              <p className="text-stone-600 text-sm mb-4">Funciona sem qualquer equipamento.</p>
              ...
              <div className="mt-4 bg-rose-50 border border-rose-200/60 rounded-xl p-4">
                <p className="text-stone-800 text-sm font-semibold">A linha indica aproximadamente Oeste → Leste.</p>
                <p className="text-stone-600 text-xs mt-1">Primeiro ponto = Oeste · Segundo ponto = Leste</p>
              </div>
            </div>
          </div>
        </Section>
        ...
        <Section num={2} title="Uso Correto da Bússola">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">
            A bússola aponta para o <strong className="text-stone-800">Norte magnético</strong>.
          </p>
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl overflow-hidden mb-4">
            ...
            <div className="p-5 md:p-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-xs font-bold text-rose-600 mb-2">Partes Principais</h4>
                ...
                <div>
                  <h4 className="text-xs font-bold text-rose-600 mb-2">Como Usar</h4>
          ...
          <div className="bg-red-100 border-2 border-red-300 rounded-2xl p-5">
            <h4 className="text-sm font-bold text-red-800 mb-2">Erros Comuns</h4>
        ...
        <Section num={3} title="Leitura de Terreno">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">
            O terreno fornece <strong className="text-stone-800">pistas naturais de direção e segurança</strong>.
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/80 border border-stone-200/60 rounded-2xl p-5">
              <h4 className="text-sm font-bold text-stone-800 mb-3 flex items-center gap-2">
                <Mountain size={14} className="text-rose-500" /> Em Áreas Rurais
              </h4>
            ...
            <div className="bg-red-50/60 border border-red-200/60 rounded-2xl p-5">
              <h4 className="text-sm font-bold text-red-700 mb-3">Evitar</h4>
              <div className="space-y-1.5">
        ...
        <Section num={4} title="Referências Urbanas">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">
            Mesmo sem GPS, <strong className="text-stone-800">cidades oferecem orientação</strong>.
          </p>
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl overflow-hidden mb-4">
            ...
            <div className="p-5 md:p-6">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mb-4">
                {['Igrejas', 'Torres', 'Morros', 'Linhas de transmissão', 'Estradas principais'].map(item => (
                  <div key={item} className="bg-stone-50 rounded-xl p-2.5 text-center">
              ...
              <div className="bg-rose-50 border border-rose-200/60 rounded-xl p-4">
                <p className="text-stone-800 text-sm font-semibold mb-2">Sempre identificar:</p>
                <div className="grid grid-cols-3 gap-2">
                  {['1 ponto alto', '1 via principal', '1 referência fixa'].map(item => (
                    <div key={item} className="bg-white/70 rounded-lg p-2 text-center">
                      <span className="text-xs font-semibold text-rose-600">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* ══ 5 — PLANEJAMENTO DE DESLOCAMENTO ══ */}
        <Section num={5} title="Planejamento de Deslocamento">
          <div className="bg-rose-50 border border-rose-200/60 rounded-2xl p-5 md:p-6 mb-4">
            <p className="text-stone-800 text-sm font-bold mb-4 flex items-center gap-2">
              <Route size={16} className="text-rose-500" /> Regra de ouro: nunca andar sem objetivo definido.
            </p>
            <h4 className="text-xs font-bold text-rose-600 mb-2">Antes de sair:</h4>
          ...
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl p-5 md:p-6">
            <h3 className="text-base font-bold text-stone-800 mb-3">Ritmo Seguro de Caminhada</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-stone-50 rounded-xl p-4 text-center">
                <span className="text-2xl font-bold text-stone-800 block">4–5</span>
                <span className="text-xs text-stone-500">km/h em terreno plano</span>
              </div>
              <div className="bg-amber-50 rounded-xl p-4 text-center">
                <span className="text-2xl font-bold text-amber-700 block">~3</span>
        ...
        {/* ══ 6 — MARCAÇÃO DE CAMINHO ══ */}
        <Section num={6} title="Marcação de Caminho">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">Se precisar retornar:</p>
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl p-5 md:p-6">
            ...
            <div className="mt-4 bg-amber-50 border border-amber-200/60 rounded-xl p-3">
              <p className="text-amber-700 text-xs font-semibold">⚠ Nunca deixar sinais óbvios que exponham rota.</p>
            </div>
          </div>
        </Section>
        ...
        <Section num={7} title="Navegação Noturna">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5 mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-bold text-red-700">Evitar sempre que possível.</span>
            </div>
          </div>
          ...
          <div className="bg-white/80 border border-stone-200/60 rounded-2xl overflow-hidden">
            ...
            <div className="p-5 md:p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-bold text-stone-800">Se inevitável:</h3>
              </div>
        ...
        <Section num={8} title="Sinais de Desorientação">
          <p className="text-stone-600 text-sm leading-relaxed mb-4">Se perceber:</p>
          <div className="grid grid-cols-3 gap-3 mb-4">
            {['Andando em círculos', 'Dúvida constante de direção', 'Irritação crescente'].map(item => (
              <div key={item} className="bg-amber-100 border-2 border-amber-300 rounded-xl p-3 text-center">
