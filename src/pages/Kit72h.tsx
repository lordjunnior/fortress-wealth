    ...
    >
      <div className="max-w-4xl mx-auto px-5 md:px-8 pt-20 pb-32">
        ...
        >
          ...
          <div className="mt-6 bg-white/60 rounded-xl p-4 border border-rose-100">
            <p className="text-stone-700 text-sm font-semibold leading-relaxed">
              ...
              O Kit 72h cobre cinco pilares críticos: <span className="text-rose-600">Hidratação</span>,{' '}
              <span className="text-amber-600">Energia calórica</span>,{' '}
              <span className="text-stone-500">Identificação</span>,{' '}
              <span className="text-emerald-600">Informação</span> e{' '}
              <span className="text-rose-500">Continuidade médica</span>.
            </p>
          </div>
        </motion.section>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-stone-800">1. Água — Prioridade Absoluta</h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/80 border border-stone-200/60 rounded-xl p-5">
              <p className="text-stone-600 text-sm leading-relaxed">
                O corpo humano tolera vários dias sem alimento, mas apenas <strong className="text-stone-800">48–72 horas sem água</strong> em clima quente.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50/80 border border-blue-200/50 rounded-xl p-5">
                <p className="text-[10px] font-bold tracking-widest uppercase text-blue-500 mb-2">Quantidade Mínima</p>
                <p className="text-2xl font-bold text-stone-800">3L <span className="text-sm font-normal text-stone-500">/pessoa/dia</span></p>
                <p className="text-stone-500 text-xs mt-1">Para 72h → <strong className="text-stone-700">9 litros por pessoa</strong></p>
                <p className="text-stone-400 text-xs mt-0.5">Se possível: 12 litros (margem de segurança)</p>
              </div>

              <div className="bg-white/80 border border-stone-200/60 rounded-xl p-5">
                <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400 mb-2">Estratégia Inteligente</p>
                <p className="text-stone-600 text-sm leading-relaxed">
                  Não concentrar toda água em um único recipiente. Distribuir em <strong className="text-stone-700">garrafas individuais</strong>, <strong className="text-stone-700">galão reserva</strong> e <strong className="text-stone-700">recipiente colapsável</strong>.
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-stone-800">2. Alimento — Energia Funcional</h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/80 border border-stone-200/60 rounded-xl p-5">
              <p className="text-stone-600 text-sm leading-relaxed mb-3">
                Alimento no Kit 72h deve priorizar: <strong className="text-stone-700">alta densidade calórica</strong>, baixo volume, longa validade e preparação simples.
                Objetivo: manter energia estável, não dieta ideal.
              </p>
              <div className="bg-amber-50/80 rounded-lg p-3 border border-amber-100">
                <p className="text-amber-700 text-xs font-semibold">Necessidade calórica média em emergência</p>
                <p className="text-stone-700 text-sm font-bold mt-1">1.800–2.200 kcal/dia <span className="text-stone-400 font-normal">(adulto sedentário)</span></p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-emerald-50/80 border border-emerald-200/50 rounded-xl p-5">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-stone-800">3. Documentos e Identificação</h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              {DOCUMENTOS.map((doc, i) => (
                <motion.div
                  key={i}
                  className="flex items-center gap-3 bg-white/60 border border-stone-200/40 rounded-xl px-4 py-3"
                  variants={staggerChild}
                >
                  <CheckCircle2 size={14} className="text-stone-400 shrink-0" />
                  <span className="text-stone-600 text-sm">{doc}</span>
                </motion.div>
              ))}
            </motion.div>

            <div className="bg-stone-50/80 border border-stone-200/50 rounded-xl p-5">
              <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400 mb-2">Estratégia de Backup</p>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-stone-800">4. Rádio — Informação É Recurso</h2>
          </div>
            ...
            <div className="bg-emerald-50/80 border border-emerald-200/50 rounded-xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {['Pontos de distribuição de água', 'Localização de abrigos', 'Alertas de segurança', 'Atualizações climáticas'].map((item, i) => (
                  <div key={i} className="bg-white/60 rounded-lg px-3 py-2 text-stone-600 text-sm">
                    {item}
                  </div>
                ))}
              </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-stone-800">5. Medicamentos — Continuidade Terapêutica</h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-rose-50/80 border border-rose-200/50 rounded-xl p-5">
              ...
              <div className="space-y-3">
                {MEDICAMENTOS_CRITICOS.map((med, i) => (
                  <div key={i} className="flex items-center justify-between bg-white/60 rounded-lg px-4 py-2.5 border border-rose-100">
                    <span className="text-stone-700 text-sm font-semibold">{med.nome}</span>
                    <span className="text-rose-500 text-xs">Risco: {med.risco}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white/80 border border-stone-200/60 rounded-xl p-5">
              <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400 mb-3">Estrutura Mínima</p>
              <ul className="space-y-1.5">
                {[
        ...
        {/* ══════════════════════════════════════════════════════════
           ...
           ══════════════════════════════════════════════════════════ */}
        <motion.section
          className="bg-white/80 border border-stone-200/60 rounded-2xl p-6 md:p-10 mb-10"
          variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}
        >
          <div className="flex items-center gap-3 mb-5">
            <RefreshCw size={18} className="text-stone-500" />
            <h2 className="text-lg font-bold text-stone-800">Protocolo de Manutenção</h2>
          </div>
          <p className="text-stone-500 text-sm mb-5">Revisar a cada <strong className="text-stone-700">6 meses</strong>:</p>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-stone-50 rounded-xl px-4 py-3 text-stone-600 text-sm">
                <Clock size={13} className="text-stone-400 shrink-0" /> {item}
              </div>
            ))}
          </div>
        </motion.section>
