  ...
  return (
    <div className="min-h-screen bg-background pt-28 pb-0 px-4 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ═══════════════════════════════════════════════════════════ */}
        {/* SEÇÃO 1: Simulador + Argumentação (existente) */}
        {/* ═══════════════════════════════════════════════════════════ */}
        ...
        <AnimatedSection>
          <div className="text-center max-w-3xl mx-auto space-y-6">
            <p className="text-[10px] text-gold uppercase tracking-[0.3em] font-bold">
              Guia completo · Brasil · PIX + Cripto
            </p>
            <h2 className="text-3xl md:text-5xl font-bold text-foreground leading-tight">
              Como Fazer e RECEBER PIX com Criptomoedas no Brasil{' '}
              <span className="text-muted-foreground">(Bitcoin, USDT, Ethereum)</span>{' '}
              — Guia Completo
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-4">
              <a href="#passo-a-passo" className="px-6 py-3 bg-gold text-background font-bold rounded-lg text-sm hover:brightness-110 transition-all">
                Ver passo a passo agora
              </a>
              <a href="#como-funciona" className="px-6 py-3 bg-card border border-border text-foreground font-bold rounded-lg text-sm hover:border-gold/50 transition-all">
                Entender como funciona
              </a>
              <a href="#apoiar" className="px-6 py-3 bg-card border border-border text-gold font-bold rounded-lg text-sm hover:border-gold/50 transition-all">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 pt-6 text-xs text-muted-foreground font-mono uppercase tracking-wider">
              <span>Sem cadastro aqui</span>
              <span>Sem promessa</span>
              <span>Sem recomendação de investimento</span>
              <span>Didático + direto</span>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className="w-10 h-10 rounded-full bg-gold/10 text-gold font-bold text-lg flex items-center justify-center mx-auto mb-4">
                  {item.num}
                </div>
        ...
        <AnimatedSection id="passo-a-passo">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-0">
              {[
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-full bg-gold/10 border border-gold/20 text-gold font-mono font-bold text-sm flex items-center justify-center shrink-0 relative z-10">
                    {item.step}
                  </div>
                  <div className="pt-1">
            ...
            {/* Dica estratégica */}
            <div className="bg-card border border-border rounded-2xl p-8 mt-8 space-y-4">
            ...
            {/* CTA intermediário */}
            <div className="bg-card border border-border rounded-2xl p-8 mt-8 text-center space-y-4">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <a href="#riscos" className="px-6 py-3 bg-card border border-border text-foreground font-bold rounded-lg text-sm hover:border-gold/50 transition-all">
                  Ver riscos antes
                </a>
                <a href="#apoiar" className="px-6 py-3 bg-gold/10 border border-gold/20 text-gold font-bold rounded-lg text-sm hover:bg-gold/20 transition-all">
                  Apoiar
                </a>
              </div>
            </div>
        ...
        <AnimatedSection id="riscos">
          <div className="max-w-4xl mx-auto">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Riscos & segurança (o que ninguém te fala)
            </h3>
            <p className="text-muted-foreground text-lg mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">
                  Saldo em exchange ≠ autocustódia.
                </p>
                <div className="border-t border-border pt-4 mt-4">
                  <p className="text-foreground font-bold text-sm">Not your keys…</p>
                  <p className="text-muted-foreground text-sm">…not your money</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 bg-background border border-border rounded-md text-xs text-muted-foreground">Limites</span>
                  <span className="px-3 py-1 bg-background border border-border rounded-md text-xs text-muted-foreground">Bloqueios</span>
                  <span className="px-3 py-1 bg-background border border-border rounded-md text-xs text-muted-foreground">Mudanças de política</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 bg-background border border-border rounded-md text-xs text-muted-foreground">Sem certezas</span>
                  <span className="px-3 py-1 bg-background border border-border rounded-md text-xs text-muted-foreground">Tenha plano B</span>
                </div>
              </motion.div>
            </div>

            {/* Conclusão prática */}
            <div className="mt-12 p-8 border-l-2 border-gold bg-gold/5 rounded-r-xl">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              <a href="#faq" className="px-6 py-3 bg-card border border-border text-foreground font-bold rounded-lg text-sm hover:border-gold/50 transition-all">
                Tirar dúvidas (FAQ)
              </a>
              <a href="#apoiar" className="px-6 py-3 bg-gold/10 border border-gold/20 text-gold font-bold rounded-lg text-sm hover:bg-gold/20 transition-all">
                Manter gratuito
        ...
        <AnimatedSection id="como-funciona">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 space-y-6 mt-6">
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full bg-card border border-border rounded-2xl p-6 text-left hover:border-gold/30 transition-all flex items-center justify-between"
              >
              ...
              {showPlatform && (
                <motion.div
                  ...
                  className="bg-card border border-border border-t-0 rounded-b-2xl p-8 -mt-2"
                >
        ...
        <AnimatedSection id="faq">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-10">
              Perguntas que todo mundo faz — respondidas sem enrolação.
            </p>
        ...
        <AnimatedSection id="apoiar">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 space-y-6 text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Tempo de curadoria, construção de páginas, organização de biblioteca, apps e guias.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Se você quer ver isso crescendo (mais apps, mais guias, mais material), Lightning é o caminho mais coerente.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
