...
import bgAutonomoDeep from '@/assets/bg-autonomo-deep.jpg';
import bgAutonomoMid from '@/assets/bg-autonomo-mid.jpg';
import bgAutonomoHero from '@/assets/bg-autonomo-hero.jpg';
