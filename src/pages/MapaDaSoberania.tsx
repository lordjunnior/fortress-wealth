...
const SILOS: Silo[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Abrigo de Emergência", href: "/projeto-autonomo/abrigo-emergencia" },
      { title: "Comunicação Offline", href: "/projeto-autonomo/comunicacao-offline" },
      { title: "Navegação Primária", href: "/projeto-autonomo/navegacao-primaria" },
      { title: "Conservação e Armazenamento", href: "/projeto-autonomo/conservacao-armazenamento" },
    ],
  },
  {
    ...
    links: [
      { title: "Horta Urbana", href: "/projeto-autonomo/horta-urbana" },
      { title: "Solo e Fertilidade", href: "/projeto-autonomo/solo-fertilidade" },
      { title: "Produção em Pequenos Espaços", href: "/projeto-autonomo/producao-pequenos-espacos" },
      { title: "Proteína Sustentável", href: "/projeto-autonomo/proteina-sustentavel" },
    ],
  },
  {
    ...
    links: [
      { title: "Hub Autonomia Biológica", href: "/projeto-autonomo/autonomia-biologica" },
      { title: "Primeiros Socorros", href: "/projeto-autonomo/primeiros-socorros" },
      { title: "Avaliação de Sinais Vitais", href: "/projeto-autonomo/avaliacao-sinais" },
      { title: "Saúde Preventiva", href: "/projeto-autonomo/saude-preventiva" },
      ...
      { title: "Manipulação Informacional", href: "/projeto-autonomo/toxicos-ocultos/manipulacao-informacional" },
      { title: "Dependência Tecnológica", href: "/projeto-autonomo/toxicos-ocultos/dependencia-tecnologica" },
    ],
  },
  {
    ...
    links: [
      { title: "Hub Conhecimento Perdido", href: "/projeto-autonomo/conhecimento-perdido" },
